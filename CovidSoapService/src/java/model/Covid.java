...
public class Covid implements Serializable {
    ...
    public Covid(Integer id, int yearnum, int weeknum, String province, int newCase, int totalCase, int newCaseExcludeabroad, int totalCaseExcludeabroad, int newDeath, int totalDeath, String updateDate) {
        this.id = id;
